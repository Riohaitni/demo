...
#     return redirect('dsloimoikb.html', receiver_id=receiver_id)
#
#
# def friend_requests(request):
#     friend_request = FriendRequest.objects.filter(receiver=request.user, is_accepted=False)
#     return render(request, 'dsloimoikb.html', {'friend_request': friend_request})
#
#
...
#             friend_request.save()
#             return redirect('accepted_friends')
#
#         elif action == 'reject':
#             friend_request.delete()
#             return redirect('friend_requests')
#
#     return render(request, 'snippets/dsbb.html', {'friend_request': friend_request})
#
#
# def list(request):
...
def send_friend_request(request, receiver_id):
    ...
    return redirect('dskb', receiver_id=receiver_id)
...
def friend_requests(request):
    friend_request = FriendRequest.objects.filter(receiver=request.user, is_accepted=False)
    return render(request, 'snippets/dsloimoikb.html', {'friend_requests': friend_request})
